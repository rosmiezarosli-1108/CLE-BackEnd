...
public class ContainerService : IContainerService
{
    ...
    public static ContainerDto MapToDto(Container container) => new()
    {
        ...
        AcceptedTime = container.AcceptedTime,
        ...
        RTAcceptedTime = container.RTAcceptedTime,
    ...
    public async Task<ContainerDto?> UpdateAsync(int id, ContainerUpdateDto dto, string updatedBy)
    {
        ...
        container.AcceptedTime = dto.AcceptedTime;
        ...
        container.RTAcceptedTime = dto.RTAcceptedTime;
